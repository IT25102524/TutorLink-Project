...
<head>
    ...
    <title>Edit Review - TutorLink</title>
            ...
            <div class="review-layout">
                <div class="review-card">
                    <div class="review-header">
                        <div class="review-icon"><i class="fas fa-edit"></i></div>
                        <h3 style="font-weight: 800; color: #0f172a; margin-bottom: 8px;">Edit Your Review</h3>
                        <p class="text-muted" style="font-size: 0.95rem;">Update your rating and comments for this session.</p>
                    </div>

                    <form action="${pageContext.request.contextPath}/review/edit/${reviewId}" method="post">
                        <input type="hidden" name="tutorId" value="${tutorId}">
                        <input type="hidden" name="rating" id="ratingVal" value="">

                        <div class="mb-4">
                            <label class="st-label text-center w-100">Update Rating *</label>
                        ...
                        <div class="mb-4">
                            <label class="st-label">Update Comment *</label>
                            <textarea name="comment" class="st-input" rows="5" required placeholder="Update your experience..."></textarea>
                        </div>
